...
//  Code modified by Paraniod Ferret Productions
//  Date: 12-09-2007
//  
////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
//
//  Updated to match Flex SDK 4.1 JPEGEncoder by slaingod
//  Date: 12-11-2010
//  
////////////////////////////////////////////////////////////////////////////////
...
package com.pfp.utils
{
	...
	public class JPEGAsyncEncoder extends EventDispatcher
	{
		 ...
		 *  @productversion Flex 3
		 */
		public function JPEGAsyncEncoder(quality:Number = 50.0)
		{
			super();
		...
		private var pixelsPerIter:int = 350;
		private var working:Boolean = false;
		private var sourceBitmapData:BitmapData = null;
		private var sourceByteArray:ByteArray = null;
		...
		private function StartEncode():void
		{
			...
			this.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS, false, false, 0, height * width));
		...
		{
//			trace(xpos.toString() + ":" + ypos.toString());
			var currentPos:int = xpos * ypos;
			var lastPercent:Number = currentPos / totalSize;
			...
			{ 
				...
				if(( currentPos / totalSize - 1.0) > lastPercent) {
					this.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS, false, false, currentPos, totalSize));
					lastPercent = currentPos / totalSize; 				
				}  	
				...
				if(ypos >= height)
				{
					setTimeout(FinishEncode, 1);
					return;
				}
				
			}
			setTimeout(AsyncLoop, 1, xpos, ypos);
		}
