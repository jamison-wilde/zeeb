  ...
  return (
    <div data-testid="rename-preview" className="flex items-center gap-2 px-2 py-1.5 bg-surface border-t border-line">
      <button
        ...
        className={`px-4 py-1 rounded-[3px] bg-accent text-on-accent text-body font-bold shrink-0 ${
      ...
      <button
        ...
        className="px-3 py-1 rounded-[3px] border border-toggle-off text-ink-2 text-body font-bold shrink-0"
        onClick={onSkip}
      >
        Skip
      </button>
      <input
        ...
        className="flex-1 px-2 py-1 font-mono text-body text-ink-bright bg-raised border border-line rounded-[3px]"
        value={previewName}
